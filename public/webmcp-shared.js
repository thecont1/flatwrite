...
export const ASSIST_DOCUMENT_OUTPUT_SCHEMA = {
    ...
    description: 'Result of Morph-powered document assist. Returns full markdown with the edit applied, ' +
...
export const RENDER_TOOLS_DOCS = [
    ...
    },
    {
        ...
        description: 'Triggers the editor\'s built-in preview pane. No HTML is returned — this tool produces a ' +
    ...
    },
    {
        ...
        description: 'Rewrite, shorten, fix grammar, or apply a custom instruction to markdown via FlatWrite Assist ' +
